...
//    List<CompanyPost> findTop5ByTravelArea(@Param("country") String country);
    ...
    @Query("SELECT c FROM CompanyPost c WHERE :country MEMBER OF c.travelArea AND c.isRecruitCompleted = false ORDER BY c.createdAt DESC")
    List<CompanyPost> findTop5ByTravelAreaLike(@Param("country") String country);
