...
public class MarketPostService {
    ...
    @Autowired
    public MarketPostService(MarketPostRepository marketPostRepository, UserRepository userRepository, ImageRepository imageRepository, CountryRepository countryRepository, LocationRepository locationRepository, ScrapService scrapService) {
    ...
    private MarketPostResponseDTO mapToMarketPostResponseDTO(MarketPost marketPost) {
        return MarketPostResponseDTO.builder()
                .marketPostId(marketPost.getMarketPostId())
                .userId(marketPost.getUser().getUserId())
                .countryId(marketPost.getCountry().getCountryId())
